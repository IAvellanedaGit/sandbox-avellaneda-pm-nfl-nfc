...
mutate_output(value:number):boolean {
  const offset = this.bb!.__offset(this.bb_pos, 4);
...
static addOutput(builder:flatbuffers.Builder, output:number) {
  builder.addFieldInt32(0, output, 0);
}
...
static createIntResponse(builder:flatbuffers.Builder, output:number, errorOffset:flatbuffers.Offset):flatbuffers.Offset {
